public class Count of Substrings Containing Every Vowel and K Consonants II {
  class Solution {
    ...
    public long atLeast(String words, int k){
        ...
        for(int right = 0; right < n; right++){
            ...
            // shrinking
            //Kyunki agar substring [left ... right] valid hai
            //to [left ... right+1], [left ... right+2] ... sab valid rahenge.
            //Isliye ek hi baar me (n - right) add kar diya.
